...
package com.example.testdemo.tasker
        ...
        return Intent()
                ...
                .putExtra(ApiIntent.EXTRA_STRING_BLURB,
                        if (profile != null) context.getString(
                                if (switchOn) com.github.shadowsocks.core.R.string.start_service else com.github.shadowsocks.core.R.string.stop_service, profile.formattedName)
                        else context.getString(if (switchOn) com.github.shadowsocks.core.R.string.start_service_default else com.github.shadowsocks.core.R.string.stop))
    }
}
